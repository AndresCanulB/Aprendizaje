...
importers:
  ...
  .:
    ...
    devDependencies:
      ts-node-dev:
        specifier: ^2.0.0
        version: 2.0.0(@types/node@26.1.1)(typescript@7.0.2)
...
packages:
  ...
  mongoose@9.8.0:
    resolution: {integrity: sha512-PDGx3XACxrBQyWf4YT+5s1Xsx19x84UWGlRVIza4i9RG6qKjGcoG7odotT6uquR6YoaDMTZ6ZZc/jMXLrNPyyA==}
    engines: {node: '>=20.19.0'}
...
snapshots:
  ...
  ts-node-dev@2.0.0(@types/node@26.1.1)(typescript@7.0.2):
    dependencies:
      chokidar: 3.6.0
      dynamic-dedupe: 0.3.0
      minimist: 1.2.8
