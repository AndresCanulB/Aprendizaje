    ...
    experience: [
      {
        ...
        description: "Desarrollé bibliotecas de componentes y lideré rediseños de arquitectura frontend."
      },
      {
        role: "Desarrolladora Frontend",
        company: "Webify",
        period: "2017 - 2020",
        description: "Construí sitios web responsivos y colaboré con equipos de UX."
      }
    ],
    stats: {
      projects: 30,
    ...
    experience: [
      {
        ...
        description: "Lideré la adopción de microservicios y mejoré la escalabilidad del sistema."
      },
      {
        role: "Desarrollador Backend",
        company: "CloudTech",
        period: "2016 - 2019",
        description: "Implementé APIs RESTful y gestioné infraestructura en la nube."
      }
    ],
    stats: {
      projects: 18,
    ...
    experience: [
      {
        ...
        company: "TechForge",
        period: "2020 - Presente",
        description: "Desarrollé soluciones integrales usando Vue.js y Node.js."
      },
      {
        role: "Desarrolladora Frontend",
    ...
    experience: [
      {
        ...
        description: "Implementé pipelines CI/CD y gestioné clusters de Kubernetes."
      },
      {
        role: "Ingeniero de Sistemas",
        company: "TechNova",
        period: "2015 - 2018",
        description: "Mantuve entornos en la nube y flujos de trabajo de despliegue."
      }
    ],
    stats: {
      projects: 15,
    ...
    experience: [
      {
        ...
        period: "2019 - Presente",
        description: "Lideré el desarrollo frontend usando Angular y TypeScript."
      },
      {
    ...
    experience: [
      {
        ...
        company: "PixelWorks",
        period: "2019 - Presente",
        description: "Construí componentes de interfaz de usuario de alto rendimiento con Vue.js."
      }
    ],
    stats: {
      projects: 17,
    ...
    experience: [
      {
        ...
        company: "WebWorks",
        period: "2020 - Presente",
        description: "Desarrollé aplicaciones full-stack usando React y Node.js."
      }
    ],
    stats: {
      projects: 14,
  ...
  },
  {
    ...
    experience: [
      ...
      },
      {
        ...
        company: "SysOps Inc.",
        period: "2014 - 2017",
        description: "Gestioné despliegues en la nube y flujos de trabajo de automatización."
      }
    ],
    stats: {
      projects: 28,
