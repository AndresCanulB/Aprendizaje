...
export const ScrambleWords = () => {
  ...
  // El useEffect tambien se puede usar en valores dentro de estados de useReducers.
  useEffect(() => {
    // Evita que el confetti se dispare al montar el componente por primera vez
    if (points === 0) return;
